...
public class PlayerController : MonoBehaviour
{
    ...
    float gameOverButtonDelay = 5.0f;
    ...
    void Update()
    {
        ...
        if (!sensorsActive && maxXPosition == 1085f)
        {
            ...
            StartCoroutine(ShowGameOverButtonAfterDelay(gameOverButtonDelay));
    ...
    private System.Collections.IEnumerator ShowGameOverButtonAfterDelay(float delay)
    {
